/*Write a Program to Solve Boundary Value Problems Using Shooting Method.*/
#include <stdio.h>

/* Define equations
   y' = z
   z' = -y  (example equation y'' = -y)
*/
...
int main()
{
    ...
    /* Interpolation to improve slope */
    z = z1 + (z2-z1)*(yn-y1)/(y2-y1);

    printf("\nImproved initial slope = %f\n",z);

    /* Final solution with corrected slope */
